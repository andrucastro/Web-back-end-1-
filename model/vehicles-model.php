...
function deleteVehicle($invId){
    ...
    function getVehiclesByClassification($classificationName){
     ...
     // Get all the information from vehicles with  the large imgPath from image table
     function getVehiclesInfoDetail($invId){
      $db = phpmotorsConnect();
      $sql ="SELECT * FROM inventory JOIN images ON images.invId = inventory.invId AND imgPath NOT LIKE '%-tn%' WHERE inventory.invId = :invId";
      $stmt = $db->prepare($sql);
      $stmt->bindValue(':invId', $invId, PDO::PARAM_INT);
      $stmt->execute();
      $vehicles = $stmt->fetchAll(PDO::FETCH_ASSOC);
